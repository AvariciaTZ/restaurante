<div class="container__menuHorizontal">
    <nav class="menuHorizontal">
        ...
        <ul class="menuHorizontal__items">
            <li><a href="<?= base_url ?>index.php?controller=inicio&action=index">Principal </a></li>
            <li class="menuHorizontal__li" id="menuHorizontal__li">
                ...
                <ul class="menuHorizontal__items menuHorizontal__items2" id="menuHorizontal__items2">
                    ...
                    ?>
                        ...
                        <li class="menuHorizontal__items--li">
                            <a href="<?= base_url ?>index.php?controller=producto&action=gestion">Producto administrador</a>
                        </li>
                    <?php
                    }
                    ?>
            ...
            <li class="menuHorizontal__li" id="menuHorizontal__li"><a href="<?= base_url ?>index.php?controller=producto&action=verEnCarta">Servicios</a>

                <ul class="menuHorizontal__items menuHorizontal__items2" id="menuHorizontal__items2">
                    <li class="menuHorizontal__items--li"><a href="<?= base_url ?>index.php?controller=producto&action=verEnCarta">Carta</a></li>
                </ul>
            </li>

            <li><a href="<?= base_url ?>/views/nosotros.php?controller=inicio&action=index">Nosotros</a></li>
        </ul>
